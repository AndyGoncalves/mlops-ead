...
data = pd.read_csv(f'https://raw.githubusercontent.com/renansantosmendes/lectures-cdas-2023/master/fetal_health_reduced.csv')

data.to_csv('fetal_health_reduced.csv', index=False)
